            ...
            <div className="bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 shadow-sm h-full flex flex-col justify-center">
              {!isSubmitted ? (
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="pt-2 space-y-3">
                    ...
                    <p className="text-center text-[10px] text-slate-400 font-geist">
                      ...
                      <a href="tel:0717270094" className="text-blue-600 font-semibold hover:underline">071 727 0094</a>
                ...
                <div className="text-center py-12 space-y-6 flex flex-col items-center">
                  ...
                  <div>
                    <h3 className="text-xl font-medium text-slate-900 tracking-tight font-jakarta mb-2">Message Sent Successfully!</h3>
                    <p className="text-slate-500 text-sm max-w-sm mx-auto font-jakarta">
                      Thank you for contacting CS Construction &amp; Projects. We'll get back to you within 24 hours. For urgent matters, call <a href="tel:0717270094" className="text-blue-600 font-medium">071 727 0094</a>.
                    </p>
                  </div>
                  <button
                    type="button"
